...
export default function MealForm({ initialMeal = {}, defaultDate, onSubmit, submitButtonLabel }) {
...
//DELETING/////////////////////////////////////////////////////
  ...
  //This is the function used by the "Add Grocery Item" button.
  ...
  //Part of the Modal.  It's the back to Update button.
  ...
  return (
    <View style={{ padding: 20, flex: 1 }}>
      {/* Date Input */}
        ...
        {/* Show Date Picker if button is pressed (datepicker doen't play nice with expoGo) */}
